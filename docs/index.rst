...
The documentation below also consists of two parts: The readme with
installation and usage instructions and the API documentation.
...
Redock in their own Python projects. Here are the contents of the API
documentation:
